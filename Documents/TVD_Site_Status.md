...
- **Carryover:** header/meta copy ("Word games with guillotines") now undersells the catalog; `dlyh-concept.png` 5.6 MB orphan still present; "Planning" badge undersells the built-scene Up Next titles. None blocking.
